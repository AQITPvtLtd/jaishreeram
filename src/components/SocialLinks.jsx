...
const SocialLinks = () => {
    return (
        <div>
            <div className="hidden sm:flex gap-4 fixed top-0 mt-[200px] right-0 flex-col justify-center items-center p-4 bg-gray-200 z-40 rounded-l-xl shadow-2xl">
                {/* facebook */}
                ...
                <div className="group relative w-max transition-transform duration-500 hover:scale-125">
                    <Link
                        href="https://www.instagram.com/jsr_pvt_ltd/"
                        role="button"
                        target="_blank"
                    >
